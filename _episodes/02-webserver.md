...
- "AWS is a computer cloud that contains some bioinformatic instances."
...
the distribution of the functional annotation of its genes can be known, even without knowing from which 
...
command line metagenomic tools needed fot this workshop. Lets practice logging in into this service and 
